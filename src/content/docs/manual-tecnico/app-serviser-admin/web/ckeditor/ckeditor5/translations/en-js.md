...
description:  Documentación Técnica del Archivo `en.js`
---

# Documentación Técnica del Archivo `en.js` (Carpeta `ckeditor5/translations`)

## Propósito del Archivo
El archivo `en.js` es un archivo de traducción que contiene las cadenas de texto en inglés para el editor CKEditor 5. Este archivo permite que el editor se muestre en el idioma inglés, proporcionando una experiencia de usuario localizada para los hablantes de este idioma.
...
# Technical Documentation of the File `en.js` (Folder `ckeditor5/translations`)

## Purpose of the File
The `en.js` file is a translation file that contains the English strings for the CKEditor 5 editor. This file allows the editor to be displayed in the English language, providing a localized user experience for speakers of this language.
